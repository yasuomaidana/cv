...
export const portfolioItems:PortFolioItem[] = [{
    ...
    "description": <><p>This prototype simulates a car that has an alcohol sensor.</p><p>Here when the alcohol sensor reaches a given threshold it will disable manual control and will enter into automatic mode.</p><p>In the automatic mode it will follow a given route.</p><p>The concept is to design a car that detects when the driver has been drinking and doesn't not allow him to drive.</p><p>Personally, I think that this should be a MUST by law characteristic when the autonomous vehicles technology has matured.</p></>,
...
},
    {
        ...
        "portFolioMedia": [
            ...
            {
                "image_link":  ultimaker_with_customized_extruder_for_viscous_materials_img,
                "image_description": "Ultimaker with customized extruder for viscous materials"
            }
        ],
        "title": "3D Printer assembly and modification",
        "description": "Here you can apreciate how I modified a 3D printer to be able to print biomaterials. In this project I gave support to a master's degree student. I also created a program that modified the G-Code generated by an slicer to be able to print with the new material.",
        "links": [
            {
        ...
        "description": "This was my graduation project. In this project we designed a 3D printer that has computer vision system. The computer vision system is able to detect the printed part and record a video of the selected region. The goal was to create a video database to train a NN.",
        "links": [
            {
        ...
        "description": "In this project built and controlled a car using arduino uno and a bluetooth shield.",
        "links": [
            {
        ...
        "description": <><p>In this project we built a car that uses a NI-Myrio board.</p><p>We used that board to get wireless connection by using wifi and tcp-ip.</p><p>We controlled the car using Nintendo switch controllers, and we also controlled some servomotors to place some box in a given place.</p></>,
        "links": [
            {
        ...
        "description": <><p>In this project we use a raspberry pi 3B to control a car using wifi.</p><p>We also used a H-Bridge board to control the weels.</p><p>We controlled the car using voice commands by using google home and firebase platform.</p></>,
        "links": [
            {
        ...
        "description": <><p>In this project we replicated the characteristics shown in the small version.</p><p>Therefeore:</p><p>In this project we use a raspberry pi 3B to control a car using wifi.</p><p>We also used a H-Bridge board to control the weels.</p><p>We controlled the car using voice commands by using google home and firebase platform.</p><p></p><p>However we also added a servomotor.</p></>,
        "links": [
            {
        ...
        "description": <><p>I had the opportunity to participate in the INCmty enterpreneurship conference.</p><p>Here I took workshops related to innovaction, how to start bussiness, price strategies and other interesting bussiness topics.</p></>,
        ...
        "description": "Not everything has to be soo serious. Sometimes, I also do excersice.",
        ...
        "description": <><p>In this project we are simulating a MacbookPro line assembly.</p><p>We designed the tools used by ABB robots. We also designed the working cell.</p><p>You can also see another robot simulation.</p></>,
        "links": [
            {
        ...
        "title": "Talkshow",
        "description": <><p>I presented a workshop about antennas and telecomunications.</p><p>In that workshop I explained the key parts and process of a telecomunication systems.</p><p>As an excersice we sent a signal by using infrared leds.</p></>,
        "links": [
            {
        ...
        "description": <><p>After my paper was published I had the opportunity of presenting it at The University of Edinburgh.</p><p>Here I met extraordinary researchers and took workshops related to how we can enhance society through science, and the responsability and role of scientist.</p></>,
        ...
        "description": <><p>This is a Matlab program that simulates the water consumption of a mexican house of 3 members. In this model we introduce an error then using a machine learning algorithm we predict if there exist a leak</p><p></p><p>To execute this program you need the following packages</p><p></p><p>Simulink</p><p>Simscape</p><p>A version of matlab that supports appdesigner</p><p>To run this project please open from matlab 'Interface.mlapp' Then from app designer run the program. After that you will see an interface that allows you to run a previous simulation or if you desire run a new one It is important to say that for several days it could take some time for 7 days of simulation with my computer Lenovo ideapad320 from 2017 it takes around 14 minutes to complete, if your computer has more power it shouldn't be a problem</p><p></p><p>NOTE: If your matlab version NOT SUPPORT appdesigner or if you want to execute manually the program, to do this you need to do the following instruction Run [fug,info]=worktest(ndays,simulate,train,MB,PB,MS,PS) where Outputs fug=a boolean that says if you have a leak info=information of the leak Inputs ndays=Integer that says the number of days to be simulate simulate=A boolean that activate the simulation (1) or that load a previous simulation (0) train=Integer that says the number of days used to train the model (it must be less than ndays) MB=Magnitude of big leak (it control the area of aperture of the leak) PB=Probability of that the big leak occurs MS=Magnitude of big leak (it control the percentage of nominal aperture per house's element) PB=Probability of MS occurs (per each element)</p></>,
        "links": [
            {
